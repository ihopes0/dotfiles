...
# Resolution based items rezise feature flag
disable_resolution_based_settings=true
...
if ($disable_resolution_based_settings)
    echo "Setting default weleave parameters"
    wleave &
fi
...
if ((resolution >= 2160)); then
    ...
    wleave --protocol layer-shell -b 6 -T $T_val -B $B_val &
    ...
    wleave --protocol layer-shell -b 3 -T $T_val -B $B_val &
else
